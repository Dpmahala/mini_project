...
const TextStyle iconNames =
    TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w300, fontSize: 25);

const TextStyle contectName =
...
const TextStyle signupText = TextStyle(
